...
DOCUMENTATION = '''
    ...
    options:
      plugin:
        description: The name of this plugin, it should always be set to V(community.proxmox.proxmox) for this plugin to recognize it as it's own.
        required: true
      ...
      url:
        description:
          ...
          - You can also use templating to specify the value of the O(url).
      ...
      user:
        description:
          ...
          - You can also use templating to specify the value of the O(user).
        required: true
        type: str
        env:
          - name: PROXMOX_USER
      password:
        description:
          ...
          - You can also use templating to specify the value of the O(password).
